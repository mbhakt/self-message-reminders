...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, d as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, e as RequestStatusResponseStatus, U as UnknownError, f as RequestStatusDoneNoReplyErrorCode, g as RejectError, h as CertifiedRejectErrorCode, i as UNREACHABLE_ERROR, I as InputError, k as InvalidReadStateRequestErrorCode, m as ReadRequestType, n as Principal, o as IDL, p as MissingCanisterIdErrorCode, H as HttpAgent, q as encode, Q as QueryResponseStatus, s as UncertifiedRejectErrorCode, t as isV3ResponseBody, v as isV2ResponseBody, w as UncertifiedRejectUpdateErrorCode, x as UnexpectedErrorCode, y as decode, S as Subscribable, z as pendingThenable, A as resolveEnabled, B as shallowEqualObjects, D as resolveStaleTime, F as noop, G as environmentManager, J as isValidTimeout, K as timeUntilStale, N as timeoutManager, O as focusManager, V as fetchState, W as replaceData, X as notifyManager, Y as hashKey, Z as getDefaultState, r as reactExports, _ as shouldThrowError, a as useQueryClient, $ as useInternetIdentity, a0 as createActorWithConfig, a1 as o, b as ReactDOM, j as jsxRuntimeExports, a2 as reactDomExports, R as React, a3 as Record, a4 as Service, a5 as Func, a6 as Vec, a7 as Text, a8 as Nat, a9 as Int, aa as Bool } from "./index-NqAwaR37.js";
...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = o.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = o.useRef(0), U = o.useRef(0), St = o.useRef(0), K = o.useRef(null), [Gt, Qt] = st.split("-"), Rt = o.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
...
Service({
  "createTemplate": Func([Text, Text], [Template], []),
  "deleteMessage": Func([MessageId], [Bool], []),
  "deleteTemplate": Func([TemplateId], [Bool], []),
  "listMessages": Func([], [Vec(Message)], ["query"]),
  "listTemplates": Func([], [Vec(Template)], ["query"]),
  "sendMessage": Func([Text], [Message], []),
  "updateTemplate": Func([TemplateId, Text, Text], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    "createTemplate": IDL2.Func([IDL2.Text, IDL2.Text], [Template2], []),
    "deleteMessage": IDL2.Func([MessageId2], [IDL2.Bool], []),
    "deleteTemplate": IDL2.Func([TemplateId2], [IDL2.Bool], []),
    "listMessages": IDL2.Func([], [IDL2.Vec(Message2)], ["query"]),
    "listTemplates": IDL2.Func([], [IDL2.Vec(Template2)], ["query"]),
    "sendMessage": IDL2.Func([IDL2.Text], [Message2], []),
    "updateTemplate": IDL2.Func(
      [TemplateId2, IDL2.Text, IDL2.Text],
      [IDL2.Bool],
      []
    )
  });
...
class Backend {
  ...
  async createTemplate(arg0, arg1) {
  ...
  async updateTemplate(arg0, arg1, arg2) {
    if (this.processError) {
      try {
